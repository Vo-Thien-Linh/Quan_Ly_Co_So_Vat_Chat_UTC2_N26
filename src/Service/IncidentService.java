...
public class IncidentService {
	...
	public void reportIncident(String reportedBy, String deviceId, String roomId, String description)
			throws SQLException {
	...
	public void handleIncident(String deviceId, String roomId, String handlingNote, String handledBy, String status)
			throws SQLException {
		if ((deviceId == null || deviceId.isEmpty()) && (roomId == null || roomId.isEmpty())) {
			throw new IllegalArgumentException("Phải cung cấp ít nhất ID phòng hoặc ID thiết bị.");
		}
		...
		if (incidents.isEmpty()) {
			throw new SQLException(
					"Không tìm thấy sự cố với ID phòng/thiết bị: " + (deviceId != null ? deviceId : roomId));
		}
