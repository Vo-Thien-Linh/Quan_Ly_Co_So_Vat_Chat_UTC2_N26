...
public class PageLecture extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    PageLecture frame = new PageLecture();
     ...
     */
    public PageLecture() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(PageLecture.class.getResource("/IMG/logo-utc.png")));
        setTitle("Quản lý cơ sở vật chất UTC2 - Giảng Viên");
        ...
        // Logo
        ImageIcon originalLogo = new ImageIcon(PageLecture.class.getResource("/IMG/logo-utc (1).png"));
        ...
        String[] menuItems = {"Mượn phòng", "Mượn thiết bị", "Trả cơ sở vật chất", "Báo cáo sự cố"};
        ...
        JPanel placeholderPanel = new JPanel(); // Panel placeholder cho các chức năng chưa hoàn thiện
        placeholderPanel.setBackground(new Color(242, 242, 242));
        JLabel placeholderLabel = new JLabel("Chức năng đang phát triển");
        placeholderLabel.setFont(new Font("Arial", Font.BOLD, 20));
        placeholderLabel.setForeground(new Color(4, 42, 54));
        placeholderPanel.add(placeholderLabel);

        // Thêm panel vào CardLayout
        for (String item : menuItems) {
            if (item.equals("Mượn phòng")) {
                contentPanel.add(panelRentRoom, item);
            } else if (item.equals("Mượn thiết bị")) {
                contentPanel.add(panelRentDevice, item);
            } else {
                contentPanel.add(placeholderPanel, item); // Placeholder cho các mục chưa hoàn thiện
            }
        }

        // Tạo nút menu trong sidebar
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Session.clear();
                UserController.logout(PageLecture.this);
            }
        });

        // Sự kiện nút tên người dùng
