...
public class Panel_ManagerRoom extends JPanel {
    ...
    private JComboBox<RoomStatus> statusComboBox;
    ...
    public Panel_ManagerRoom() {
        ...
        search_1.setForeground(Color.WHITE);
        ...
        search_1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                search_1.setBackground(new Color(12, 128, 162));
            }
        ...
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                button.setBackground(new Color(12, 128, 162));
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                button.setBackground(new Color(19, 193, 244));
            }
        ...
        button_3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                button_3.setBackground(new Color(12, 128, 162));
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                button_3.setBackground(new Color(19, 193, 244));
            }
        ...
        button_1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                button_1.setBackground(new Color(12, 128, 162));
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                button_1.setBackground(new Color(19, 193, 244));
            }
        ...
        button_2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                button_2.setBackground(new Color(12, 128, 162));
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                button_2.setBackground(new Color(19, 193, 244));
            }
        ...
        button_4.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                button_4.setBackground(new Color(12, 128, 162));
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                button_4.setBackground(new Color(19, 193, 244));
            }
        ...
        String[] columns = {"ID Phòng", "Số Phòng", "Sức chứa", "Trạng thái"};
        ...
        header.setDefaultRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                lbl.setBackground(new Color(25, 25, 112));
        ...
        button_3.addActionListener(e -> {
            try {
                ...
                DefaultTableModel dialogTableModel = new DefaultTableModel(
                    new Object[][] {},
                    new String[] {"ID Request", "Lecturer", "Room ID", "Request Date", "Due Date", "Status"}
                );
                ...
                for (RoomBorrowRequest request : requests) {
                    dialogTableModel.addRow(new Object[]{
                        ...
                        request.getFullname() + " (" + request.getLecturerUser() + ")",
                        request.getRoomId(),
                ...
                approveButton.addActionListener(evt -> {
                    if (dialogTable.getSelectedRow() != -1) {
                        ...
                        if (confirm == JOptionPane.YES_OPTION) {
                            try {
                                boolean success = controller.updateRequestStatus(idRequest, BorrowingRequestStatus.APPROVED);
                ...
                rejectButton.addActionListener(evt -> {
                    if (dialogTable.getSelectedRow() != -1) {
                        ...
                        if (confirm == JOptionPane.YES_OPTION) {
                            try {
                                boolean success = controller.updateRequestStatus(idRequest, BorrowingRequestStatus.REJECTED);
        ...
        button_4.addActionListener(e -> {
            try {
                ...
                if (requests.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Không có đơn mượn phòng nào để xuất.");
                    return;
                }
                ...
                fileChooser.setSelectedFile(new java.io.File("Borrowing_Requests.csv"));
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    try (FileWriter writer = new FileWriter(fileToSave)) {
                        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                        // Sửa tiêu đề cột để hiển thị "Tên Giảng viên" thay vì "Lecturer User"
                        writer.write("ID Request,Tên Giảng viên,Room ID,Request Date,Due Date,Status\n");
                        for (RoomBorrowRequest request : requests) {
                            // Sử dụng getFullname() thay vì getLecturerUser()
                            writer.write(String.format("%s,%s,%s,%s,%s,%s\n",
                                request.getIdRequest(),
                                request.getFullname(), // Thay đổi ở đây
                                request.getRoomId(),
                                dateFormat.format(request.getRequestDate()),
                                dateFormat.format(request.getDueDate()),
                                request.getBorrowingRequest().name()));
                        }
                        JOptionPane.showMessageDialog(this, "Xuất đơn mượn thành công: " + fileToSave.getAbsolutePath());
                    } catch (IOException ex) {
                        JOptionPane.showMessageDialog(this, "Lỗi khi xuất file CSV: " + ex.getMessage());
                    }
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this, "Lỗi khi tải danh sách đơn mượn: " + ex.getMessage());
            }
        });

        search_1.addActionListener(e -> searchRooms());

        // Thêm KeyListener để tìm kiếm theo thời gian thực khi người dùng gõ
    ...
    private void searchRooms() {
        ...
        try {
            ...
            modelSearch.setRowCount(0); // Xóa dữ liệu cũ
            ...
            for (Room room : allRooms) {
                ...
                if (roomId.contains(searchText) || roomNumber.contains(searchText)) {
            ...
            if (modelSearch.getRowCount() == 0 && !searchText.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Không tìm thấy phòng nào khớp với từ khóa: " + searchText);
                refreshTable(); // Tải lại toàn bộ danh sách nếu không tìm thấy
            }
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, "Lỗi khi tìm kiếm: " + ex.getMessage());
            refreshTable(); // Tải lại toàn bộ danh sách nếu có lỗi
        }
    }
