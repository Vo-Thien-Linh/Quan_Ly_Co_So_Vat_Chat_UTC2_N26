...
public class RoomBorrowRequestRepository {
    ...
    // Phương thức để lấy các đơn mượn theo user
    public List<RoomBorrowRequest> getRequestsByUser(String userId) throws SQLException {
        List<RoomBorrowRequest> requests = new ArrayList<>();
        String sql = """
            SELECT br.id_request, br.lecturer_user, u.fullname, br.room_id, 
                   br.request_date, br.due_date, br.borrowing_request
    ...
    // Phương thức để tìm kiếm đơn mượn theo ID
    public List<RoomBorrowRequest> findByRequestId(String idRequest) throws SQLException {
        List<RoomBorrowRequest> requests = new ArrayList<>();
        String sql = """
            SELECT br.id_request, br.lecturer_user, u.fullname, br.room_id, 
                   br.request_date, br.due_date, br.borrowing_request
